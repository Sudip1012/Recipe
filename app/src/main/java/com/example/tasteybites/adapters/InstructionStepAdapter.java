...
import com.example.tasteybites.models.Step;
...
public class InstructionStepAdapter extends  RecyclerView.Adapter<InstructionStepViewHolder> {
    ...
    InstructionStepAdapter(Context context,List<Step>list){
    ...
    public void onBindViewHolder(@NonNull InstructionStepViewHolder holder, int position) {
        ...
        holder.getRecycler_instructions_ingredients.setHasFixedSize(true);
        holder.getRecycler_instructions_ingredients.setLayoutManager(new LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,false));
        ...
        holder.getRecycler_instructions_ingredients.setAdapter(instructionsIngredientsAdapter);
...
class InstructionStepViewHolder extends RecyclerView.ViewHolder {
    ...
    RecyclerView recycler_instructions_equipments,getRecycler_instructions_ingredients;
    public InstructionStepViewHolder(@NonNull View itemView) {
        ...
        getRecycler_instructions_ingredients = itemView.findViewById(R.id.recycler_instructions_ingredients);
    }
}
